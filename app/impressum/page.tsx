    ...
    return (
        <main style={{ minHeight: '100vh', background: '#020810', padding: '6rem var(--px) 6rem', fontFamily: 'var(--font-barlow), sans-serif' }}>
            <div style={{ maxWidth: '760px', margin: '0 auto' }}>
                ...
                <p style={p}>
                    LinderMedia<br />
                    Inhaber: Dipl.-Ing. Andreas Linder<br />
                    Schloßstraße 31<br />
                    D – 56459 Pottum
                </p>
                ...
                <p style={p}>
                    ...
                    E-Mail: <a href="mailto:hello@lindermedia.de" style={{ color: '#fff', textDecoration: 'none' }}>hello@lindermedia.de</a><br />
                    Web: <a href="https://www.lindermedia.de" style={{ color: '#fff', textDecoration: 'none' }}>www.lindermedia.de</a>
                </p>
                ...
                <p style={p}>
                    ...
                    Schloßstraße 31, D – 56459 Pottum
                </p>
